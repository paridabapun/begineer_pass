...
//		PERFORM ADD if 1
			...
			System.out.println(availableBalance + requestAmount);
		}
		// PERFORM SUB if 2
		else if (type == 2) {
			System.out.println(availableBalance - requestAmount);
        ...
        int n = scn.nextInt();  //initial bank balance
        int opr = scn.nextInt(); //type of operation - credit or debit
        int amt = scn.nextInt(); //amount to be credit or debit
